...
public class Test05 {
	public static void main(String[]args) {
		...
		// nickname.indexOf("운영자") >= 0   <---contain과 동일 
		System.out.println(nickname.indexOf("운영자"));//좌측부터 탐색 (위치 찾을때 사용)
...
//		boolean isKorean = ch >= 44032 && ch <= 55203;// 한글 검사 
		boolean isKorean = ch >= '가' && ch <='힣';// 한글 검사 
