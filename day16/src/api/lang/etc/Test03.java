...
public class Test03 {
	public static void main(String[]args) {
		...
		//필드
		//-System.er - 표준 에러 스트림(통로)
		//-System.out - 표준 출력 스트림(통로)
		//-System.in - 표준 입력 스트림(통로)
		
		//스트림마다 용도가 정해져 있으며 혼합하여 사용하는 것을 금지 
		System.out.println("Hello");
		System.err.println("Hello");// 순서가 다르게 나올 수 있다 
		
		//메소드
		
		//[1] 시간 측정 메소드 
		//= 프로그래밍에서 기준시각이라는 것이 존재 
...
//		System.out.println(System.getProperties());
		...
		System.out.println(prop.getProperty("user.county"));//지역
...
//		if(osName.startsWith("Windows")) {
		...
		System.out.println(prop.getProperty("user.home"));//사용자 기본 폴더 
		
		//[3]프로그램 종료를 요청할 수 있다.
		//= 종료상태를 정수로 전달 할 수 있다. 
		//= 0 은 정상 종료, 0이 아니면 비정상 종료로 인식함
		//= 오류 상태 번호는 정하기 나름이다 
