...
//	@Scheduled(fixedRate = 1000)//1초(1000ms)에 한번씩 실행
...
//	@Scheduled(cron = "0 30 9,18 * * *")//출근할때(9:30),퇴근할때(18:30) 한 번씩 
//	@Scheduled(cron = "0 30 9-18 * * *")//출근부터 퇴근때까지 1시간 마다 
...
//	@Scheduled(cron = "0 0 12 ? * thuL")//매월 마지막(L) 목요일(4) 12시 정각=요일을 영어로
//	@Scheduled(cron = "0 0 12 ? * 4#1")//매월 1주차(#1) 목요일(4) 12시 정각
//	@Scheduled(cron = "0 0 12 ? * thu#1")//매월 1주차(#1) 목요일(4) 12시 정각
	@Override
